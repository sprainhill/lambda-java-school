...
{
    static final String CLIENT_ID = System.getenv("LAMBDACLIENT"); // read from environment variable
    static final String CLIENT_SECRET = System.getenv("LAMBDASECRET"); // read from environment variable
